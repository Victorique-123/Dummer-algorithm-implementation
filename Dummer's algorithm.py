#Как использовать:
#Функция decoding может быть декодирована в соответствии с алгоритмом Думера
#Вход: кодовое слово ошибки arr в двоичном формате, проверочная матрица H
#Вывод: декодированное двоичное кодовое слово (если существует несколько возможных результатов декодирования, то один из них выводится вместе с ним)
