#Как использовать:
#Функция fine_e() решает задачу синдромного декодирования.
#Вход: s- синдром, w-максимальное количество ошибок, H-проверочная матрица.
#Вывод: Список, содержащий все возможные векторы ошибок.
